...
## 🚀 システム概要
- **目的**: FANZA(商業), DLsite, DMMブックス, DigiKet, らぶカル(Lovecal) の新着・ランキングを取得し、DeepSeek AIで紹介記事を生成して WordPress に自動投稿する。
- **主要言語**: Python 3.x
...
| `novelove_writer.py` | AI執筆エンジン。プロンプト構築・DeepSeek API通信・記事生成 |
