...
### 2. AI SEOメタ自動生成
通常レビュー記事生成時に、DeepSeekへの指示に `SEO_META:` セクションを追加。
- **seo_title**: あらすじに基づく32文字以内のクリックしたくなるタイトル
- **meta_desc**: 80文字程度。性癖直撃・読後感情を約束する惹き句

AI生成できた場合は優先採用、できなかった場合はテンプレートにフォールバック。

### 3. 多段ガードレール
- **サーキットブレーカー**: 連続エラー3回 or 10分超過で自動停止 → Discord緊急通知
- **クールダウン**: 通常投稿55分・ランキング12時間の独立した間隔制御
- **重複防止**: DB全件 + WordPress公開記事のタイトル照合で二重投稿を100%排除
