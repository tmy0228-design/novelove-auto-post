...
## 🚀 システム概要
- **目的**: FANZA(商業), DLsite, DMMブックス, DigiKet, らぶカル(Lovecal) の新着・ランキングを取得し、OpenRouter経由のGrok AIで紹介記事を生成して WordPress に自動投稿する。
- **主要言語**: Python 3.x
...
### 2. AI SEOメタ自動生成・付与
通常・ランキングともに、Grok AIが記事本文をベースに強力なSEO特化のテキストを生成。
