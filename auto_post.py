...
"""
==========================================================
Novelove 自動投稿エンジン v8.5.0
【アフィリエイトリンク表示ルール統一 ＆ 徹底クリーンアップ版】
==========================================================
【変更点 v8.5.0】
 - UI：アフィリエイトリンク表示ルールの統一（通常記事：画像下テキスト＋末尾ボタン）
 - UI：ランキング記事のボタン廃止・テキストリンク完全移行
 - 改善：AIへのボタン生成指示を廃止し、プログラム側で一貫した構造を自動挿入
 - 保守：特定記事（ID: 213）の復元および個別記事の発売日追加対応
==========================================================
...
- 5点：完璧に合致する良質な日本語マンガ。強く推奨できる作品。
- 4点：良質な日本語マンガ。ブログの趣旨に合っており紹介の価値がある。
- 3点：標準的だが、ブログの紹介基準（熱量）に満たない。
- 2〜1点：マンガ要素が稀薄、またはジャンルや内容がズレている。
