...
<p>（標準語で執筆）あらすじ・世界観。情報を深く噛み砕いて400〜700字程度でリッチに解説。既にある設定の魅力を別の角度から掘り下げたり、読者の期待を煽る表現で膨らませること。</p>
...
{chat_open}（60〜80字程度。{intro_rule}）{chat_close}
<h2>（作品の世界観や魅力を引き出すキャッチーな見出し）</h2>
<p>（標準語で執筆）あらすじ・世界観。300〜600字程度で解説。既にある設定の魅力を別の角度から掘り下げたり、読者の期待を煽る表現で膨らませること。</p>
