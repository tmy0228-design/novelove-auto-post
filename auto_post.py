...
"""
==========================================================
Novelove 自動投稿エンジン v8.1.3
【漫画特化・高度フィルタリング・構成最適化版】
==========================================================
【変更点 v8.1.3】
 - 構成：記事末尾を「購入リンク → 関連記事」の順序へ最適化
 - 修正：関連記事のデザインをピンク枠に正規化し二重化を解消
【変更点 v8.1.1～v8.1.2】
 - 漫画特化：ボイス・ノベル・画像集をメタデータで厳格に排除
 - 修正：投稿タグから「小説」を除去し「コミック」へ一括修正
 - 連携：削除された記事へのリンク切れを自動検知・修正
【変更点 v8.0.0】
 - 刷新：投稿ロジックを「リアルタイム厳選方式」へ移行
 - 機能：24時間周期の24枠ローテーション導入
==========================================================
"""
