...
"""
==========================================================
Novelove 自動投稿エンジン v8.0.0
【リアルタイム厳選方式・24時間最強ローテーション版】
==========================================================
【変更点 v8.0.0】
 - 刷新：投稿ロジックを「リアルタイム厳選方式（オンデマンド審査）」へ移行
 - 機能：24時間周期の24枠ローテーション導入（FANZA/DMM 20 : DLsite 4）
 - 最適化：発売日前後3日フィルタリング × あらすじ文字数順の優先審査
 - 強化：DeepSeek API制限/エラー時の自動ループ遮断・安全装置の実装
 - 強化：画像表示サイズを 500px に拡大し、PC表示の訴求力を向上
 - 廃止：promote_watching() および pending ステータスへの依存を完全排除
=========================================================="""
...
# === 取得対象ジャンル定義 ===
FETCH_TARGETS = [
    # 1〜8: 1巡目（全ジャンル一周。BL/TL小説枠を削除し、コミック・同人を増枠）
    ...
    {"site": "DMM.com", "service": "ebook",  "floor": "comic",          "genre": "comic_bl",  "label": "一般BL",   "keyword": "ボーイズラブ"},
    {"site": "DMM.com", "service": "ebook",  "floor": "comic",          "genre": "comic_tl",  "label": "一般TL",   "keyword": "ティーンズラブ"},
    # 17〜24: 3巡目（DLsite残り + FANZA/DMM補強）
    {"site": "DLsite",  "service": None,     "floor": "bl",             "genre": "doujin_bl", "label": "DLsiteBL", "keyword": None},
    {"site": "FANZA",   "service": "doujin", "floor": "digital_doujin", "genre": "doujin_bl", "label": "BL同人",   "keyword": "ボーイズラブ"},
    {"site": "FANZA",   "service": "doujin", "floor": "digital_doujin", "genre": "doujin_tl", "label": "乙女同人", "keyword": "乙女向け"},
    {"site": "DMM.com", "service": "ebook",  "floor": "comic",          "genre": "comic_bl",  "label": "一般BL",   "keyword": "ボーイズラブ"},
...
def main():
    ...
    if not posted:
        logger.info(f"⚠️ 今回のターン（{current_genre_info['label']}）は5点作品なし。1時間後に再挑戦。")
        notify_discord(f"⚠️ {current_genre_info['label']}: 候補{len(candidates)}件中5点なし（1時間後に再挑戦）")
