...
from novelove_soul import REVIEWERS, get_relationship, FACT_GUARD, NG_PHRASES, MOOD_PATTERNS, first_person_prompt_line, persona_voice_bullets
...
・文体: {reviewer["tone"]}
{persona_voice_bullets(reviewer)}
