...
2.  **アイキャッチ・書影**: 作品のメインビジュアル（中央寄せ、シャドウ付き）。
3.  **あらすじ**: 販売サイトから取得・クレンジングされた作品紹介。
4.  **ライター個別レビュー**: 5名のキャラクターから1名がランダムに選ばれ、作品を紹介します。
    -   **吹き出しコンポーネント**: `speech-bubble-left` クラスを使用。キャラ画像と共に個別の感想が表示されます。
    -   **構成**: キャラクターによる「冒頭コメント」「中間の反応」「総評」の3段構成です。
...
-   **絶対参照**: システムの動作は常に本書の記述を正（ソース・オブ・トゥルース）とします。コード修正時も本書のロジックを最優先に遵守してください。
