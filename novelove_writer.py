...
<h2>（作品の魅力を引き出す見出し）</h2>
<p>あらすじ・世界観・テーマ要素を400〜900字で解説。</p>
{chat_open}（50〜90字。リアクション）{chat_close}
<h2>キャラクターの魅力と関係性</h2>
<p>キャラクターの性格や関係性の変化を400〜900字で分析。</p>
{chat_open}（50〜90字。リアクション）{chat_close}
...
<ul style="list-style-type: none; padding-left: 0;">
  <li>✅ （あらすじ・設定の具体的な要素から導出した層。「感動的なストーリーが好きな方」等の汎用表現は禁止）</li>
  <li>✅ （同上）</li>
  <li>✅ （同上）</li>
</ul>
...
{chat_open}（60〜110字。作品への自然なリアクションで書き出す）{chat_close}
<h2>（作品の魅力を引き出す見出し）</h2>
<p>あらすじ・世界観・テーマ要素をあらすじの情報量に合わせて200〜600字で解説。情報がない要素は補完しない。</p>
{chat_open}（50〜90字。リアクション）{chat_close}
<h3>（魅力ポイント1。事実に基づく見出し）</h3>
