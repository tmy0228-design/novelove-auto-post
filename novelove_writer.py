...
12. 【絶対禁止】「公式属性タグ」「属性タグ」「あらすじ情報」などのシステム・データベース由来の言葉を記事本文に一切出力しないこと。作品情報として渡されたタグ（例：年下攻め・溺愛・執着）は、「〇〇な関係性が好きな人には堪らない」「〇〇展開に目がない」のように、あくまでキャラクターが作品の魅力を語る自然な文章に溶け込ませること。
{pattern_rules}
【対象作品情報】
タイトル: {safe_title}
